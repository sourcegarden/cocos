...
var TowerPanel = cc.Layer.extend({
    ...
    loadTower : function(){
        var towerBase = new cc.Sprite("res/gp_towerPos.png");
        this.addChild(towerBase);
        towerBase.setPosition(0, 0);

        var arrowTower = new cc.Sprite("res/gp_arrowTowerInfo.png");
        ...
        var attackTower = new cc.Sprite("res/gp_attackTowerInfo.png");
        ...
        var multiDirTower = new cc.Sprite("res/gp_multiDirTowerInfo.png");
