...
var ArrowTower = TowerBase.extend({
    ...
    loadBasePlate : function(){
        var node = new cc.Sprite("res/gp_basePlate.png");
        this.addChild(node);

        this.basePlate = node;
    },
    loadRotateArrow : function(){
        var node = new cc.Sprite("res/gp_arrow.png");
        this.addChild(node);
    ...
    shoot : function(){
        ...
        if(this.nearestEnemy != null && this.nearestEnemy.getCurrHp() > 0 ){
            ...
            //var move = cc.moveTo(this.bulletSpeed, cc.p(GC.w, GC.h));
            //
    ...
    createArrowTowerBullet : function(){
        var node = new Bullet("res/gp_arrowBullet.png");
