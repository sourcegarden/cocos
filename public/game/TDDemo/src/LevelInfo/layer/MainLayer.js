...
var LIMainLayer = cc.Layer.extend({
    ...
    loadInfoPanel : function(){
        var node = new cc.Sprite("res/li_levelInfoPanel.png");
        this.addChild(node);
    ...
    loadButton : function(){
        var startNormal    = new cc.Sprite("res/li_btnStart.png");
        var startSelected  = new cc.Sprite("res/li_btnStart.png");
        var startDisabled  = new cc.Sprite("res/li_btnStart.png");
        ...
        var backNormal    = new cc.Sprite("res/li_btnBack.png");
        var backSelected  = new cc.Sprite("res/li_btnBack.png");
        var backDisabled  = new cc.Sprite("res/li_btnBack.png");
    ...
    loadStar : function(){
        var nodeSize = new cc.Sprite("res/li_starBg.png").getContentSize();
        ...
        for (var i = 0; i < STAR_NUMBER; i++){
            ...
            var node = new cc.Sprite("res/li_starBg.png");
            this.addChild(node);
