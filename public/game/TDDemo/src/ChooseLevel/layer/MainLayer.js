...
var CLMainLayer = cc.Layer.extend({
    ...
    loadPageView : function(){
        ...
        for (var i = 0; i < LEVEL_PAGE_COUNT; i ++){
            var node = new LevelPage("res/cl_selectLevelBg_" + i + ".png", i);
    ...
    loadPageMark : function(){
        var node = new PageMark({
            ...
            space       : 20,
            length      : LEVEL_PAGE_COUNT,
            normalImg   : "res/cl_pageMark_1.png",
            selectedImg : "res/cl_pageMark_2.png"
        });
        this.addChild(node);
    ...
    loadReturnButton : function(){
        ...
        this.addChild(node);
        node.loadTextures(
            "res/cl_btnBackNormal.png",
            "res/cl_btnBackPress.png",
            "res/cl_btnBackNormal.png"
        );
