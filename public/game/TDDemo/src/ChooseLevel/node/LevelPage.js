...
var LevelPage = cc.Node.extend({
    ...
    loadSelectItem : function(){
        var size = new cc.Sprite("res/cl_card_0.png").getContentSize();
        ...
        for (var row = 0; row < LEVEL_ROW; row++){
            ...
            for (var col = 0; col < LEVEL_COL; col++){
                ...
                var nodeNormal = new cc.Sprite("res/cl_card_0.png");
                var nodeSelected = new cc.Sprite("res/cl_card_1.png");
                var nodeDisabled = new cc.Sprite("res/cl_card_2.png");
                ...
                var levelStr = cc.sys.localStorage.getItem("levelNum");
